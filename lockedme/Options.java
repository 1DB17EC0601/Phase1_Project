			...
			public static void handleWelcomeScreenInput() {
				...
				do {
					try {
						...
						switch (input) {
						case 1:
							Operators.displayAllFiles("MainClass");
							break;
						case 2:
				...
				do {
					try {
						...
						case 1:
							...
							Operators.createFile(fileToAdd, sc);
						...
						case 2:
							...
							Operators.createMainFolderIfNotPresent("main");
							List<String> filesToDelete = Operators.displayFileLocations(fileToDelete, "main");
							...
							if (idx != 0) {
								Operators.deleteFileRecursively(filesToDelete.get(idx - 1));
							} else {
								
								// If idx == 0, delete all files displayed for the name
								for (String path : filesToDelete) {
									Operators.deleteFileRecursively(path);
								}
							}
						...
						case 3:
							...
							Operators.createMainFolderIfNotPresent("main");
							Operators.displayFileLocations(fileName, "main");
